...
const Logo = () => {
  return (
	...
	<!-- outer part of H -->
      ...
      <circle
        className='st0 fill-pink-200 dark:fill-pink-400'
        cx='364.82'
        cy='341.17'
        r='175.98'
      />
      <path
        className='st1 fill-black dark:fill-white'
        d='M366.22,569.45c-106.48,0.03-197.55-70.13-224.17-170.88c-1.23-4.64-2.31-9.33-3.14-14.06
	...
	c-32.05,24.74-68.06,40.09-108.23,45.7C385.32,568.65,374.58,569.28,366.22,569.45z'
      />
      <path
        className='st2 fill-black dark:fill-white'
        d='M533.05,279.76c-13.44,3.37-26.38,0.52-39.09-3.59c-3.84-1.24-5.21-0.29-6.61,3.13
	...
	c1.26,0.27,0.75,1.49,1.17,2.2C538.36,276.08,535.92,278.09,533.05,279.76z'
      ...
      <path
        className='st2 fill-black dark:fill-white'
        d='M484.29,245.62c-0.37-0.4-0.74-0.8-1.11-1.2c4.47-7.18,11.44-11.59,18.07-16.38
	...
	c-7.48-1.49-14.91-2.31-22.37-0.01c-7.01,1.29-12.93,4.91-18.77,8.72C487.62,244.51,486.44,246.23,484.29,245.62z'
      ...
      <path
        className='st2 fill-black dark:fill-white'
        d='M532.19,252.54c0.41-0.35,0.82-0.71,1.23-1.06c1.45-0.06,2.73-0.39,3.1-2.08c0.38-0.58,0.81-1.04,1.59-0.72
	...
	c5.28-2.4,10.51-4.88,15.67-7.5C524.96,257.21,529.35,256.17,532.19,252.54z'
      />
      <path
        className='st3 fill-black dark:fill-white'
        d='M146.42,233.1c-0.36-9.6-6.01-18.07-3.72-27.38c0.48-0.09,0.95-0.17,1.43-0.26c1.19,4.39,2.72,8.72,3.46,13.19
	...
	C131.46,224.89,138.81,228.94,146.42,233.1z'
      />
      <path
        className='st4 fill-black dark:fill-white'
        d='M499.22,154.89c-1.08,1.54-1.63,2.6-2.43,3.4c-1.03,1.03-1.8-0.13-2.52-0.65
	...
	c23.03,7.36,44.43,18.01,64.2,31.9C497.67,153.84,498.47,154.38,499.22,154.89z'
      />
      <path
        className='st5 fill-black dark:fill-white'
        d='M313.79,80.4c-0.33-1.53,0.06-2.29,1.89-2.53c8.05-1.08,16.06-2.37,24.09-3.6c1.42-0.22,2.64-0.35,2.84,1.65
	...
	c-2.39,0.44-2.49-1.02-2.71-2.44C317.28,104.02,315.55,92.21,313.79,80.4z'
      ...
      <path
        className='st5 fill-black dark:fill-white'
        d='M267.41,107.23c2.35-4.36,5.66-7.34,10.42-8.72c6.92-1.99,12.25,0.07,15.12,6.67
	...
	C266.46,102.67,265.97,105.98,267.41,107.23z'
      />
      <path
        className='st6 fill-black dark:fill-white'
        d='M117.54,278.13c-4.44-10.49-0.31-20.73,8.7-22.13c3.91-0.61,7.49,1.08,11.16,2c3.21,0.81,6.35,1.84,9.54,2.73
	...
	c-7.47-2.15-14.98-4.16-22.4-6.49c-1.2-0.38-4.15,0.52-3.33-2.83C113.25,276,115.48,278.45,117.54,278.13z'
      />
      <path
        className='st7 fill-black dark:fill-white'
        d='M136.94,343.05c0.1,1.99,0.15,3.98,0.29,5.97c0.54,7.69,0.56,7.76-6.94,8.13c-9.78,0.49-19.57,0.91-29.35,1.22
	...
	C136.72,343.05,136.83,343.05,136.94,343.05z'
      ...
      <path
        className='st2 fill-black dark:fill-white'
        d='M544.14,234.65c0.37-0.01,0.73-0.11,1.1-0.12c0.99,5.35,2.09,10.79,2.96,16.16c1.19,7.31,4.47,13.41,9.74,18.62
	...
	C549.6,266.96,543.78,252.34,544.14,234.65z'
      />
      <path
        className='st8 fill-black dark:fill-white'
        d='M552.07,283.6c0.39-0.4,0.79-0.81,1.18-1.21c2.43,8.57,1.55,17.04-0.8,25.44c-1.04,3.71-1.98,7.41-1.17,11.27
	...
	c-0.17-3.76-0.01-7.74,1.03-11.31C552.73,300.02,552.99,291.88,552.07,283.6z'
      />
      <path
        className='st9 fill-black dark:fill-white'
        d='M232.93,107.92c1.34-0.02,1.54,1.33,2.07,2.28c5.55,9.82,11.1,19.63,16.56,29.49c0.74,1.33,2.78,2.81-0.02,4.47
	c-2.83,1.67-3.04-0.76-3.82-2.15c-5.55-9.81-10.97-19.69-16.61-29.46C229.67,110.06,229.89,108.69,232.93,107.92z'
      />
      <path
        className='st10 fill-black dark:fill-white'
        d='M418.94,93.23c2.98-1.88,5.89-3.38,9.38-3.05c1.33,0.13,2.8,0.07,2.49,2.13c-0.23,1.57-0.9,1.95-2.64,1.93
	...
	c1.55-7.6,3.02-15.22,4.69-22.79c0.36-1.63-0.43-4.56,2.87-4.09C420.92,88.52,418.12,91.18,418.94,93.23z'
      ...
      <path
        className='st7 fill-black dark:fill-white'
        d='M134.03,313.52c-7.63-0.9-15.2-1.74-22.76-2.74c-1.43-0.19-3.95,0.71-3.46-2.59c0.5-3.35,2.91-1.65,4.23-1.53
	c7.42,0.68,14.82,1.59,22.2,2.63c1.54,0.22,4.58-1.12,4.07,2.53C137.89,314.83,135.5,313.13,134.03,313.52z'
      />
      <path
        className='st2 fill-black dark:fill-white'
        d='M536.09,207.82c-3.63-7.27-6.99-14.67-10.73-21.9c4.77,6.49,8.68,13.43,11.65,20.9
	C536.84,207.26,536.54,207.6,536.09,207.82z'
      />
      <path
        className='st2 fill-black dark:fill-white'
        d='M536.09,207.82c0.31-0.34,0.62-0.67,0.93-1.01c2,5.31,5.09,10.21,6.03,15.92c-1.29,0.7-2.59,1.87-3.87-0.02
	c2.11,0.19,1.91-0.7,1.31-2.28C538.91,216.27,537.54,212.03,536.09,207.82z'
      />
      <path
        className='st11 fill-black dark:fill-white'
        d='M98.18,304.19c2.02,0.09,2.89,1.28,2.84,3.18c-0.04,1.66-0.97,2.84-2.6,3.02c-2.05,0.22-2.98-1.32-3.14-3
	C95.11,305.54,96.24,304.39,98.18,304.19z'
      />
      <path
        className='st12 fill-pink-600 dark:fill-pink-50'
        d='M397.88,384.22c-0.11-7.44-0.33-14.89-0.31-22.33c0.04-21.7,0.18-43.4,0.27-65.1
	...
	c-0.14,5.54-0.05,5.55-5.49,5.63c-11.17,0.17-11.17,0.17-11.62-10.84C398.19,377.12,400.22,380.85,397.88,384.22z'
      />
      <path
        className='st13 fill-pink-600 dark:fill-pink-50'
        d='M258.32,385.54c-5.38,1.48-10.86,0.29-16.28,0.58c-1.78,0.1-2.18-1.07-2.17-2.6
	...
	c-0.15,9.14-0.03,9.14-9.16,8.91C252.09,385.35,255.32,384.08,258.32,385.54z'
      />
      <path
        className='st14 fill-black dark:fill-white'
        d='M488.33,418.43c0.74,0.33,1.48,0.65,2.22,0.98c-14.21,8.18-19.99,21.91-24.14,36.69
	...
	C482.91,421.58,485.11,419.27,488.33,418.43z'
      ...
      <path
        className='st12 fill-pink-600 dark:fill-pink-50'
        d='M456.16,335.36c-0.89-0.72-1.23-2.03-0.76-2.68c4.8-6.58-0.58-13.15-0.15-19.78c0.19-2.92-3.41-6.21-5.6-9.1
	...
	C460,321.86,460.26,328.86,456.16,335.36z'
      ...
      <path
        className='st12 fill-pink-600 dark:fill-pink-50'
        d='M445.34,299.58c0.01,0.32,0.01,0.64,0.01,0.96c-3.64,0.29-7.02-0.32-10.41-1.91
	...
	c0.08-0.72,0.45-1.35,1.18-1.32c13.69,0.52,27.48-1.72,41.08,1.63C442.09,297.57,443.81,298.28,445.34,299.58z'
      ...
      <path
        className='st13 fill-pink-600 dark:fill-pink-50'
        d='M258.7,328.4c-1.07,0.35-3.52,1.38-2.62-0.54c3.25-6.94,0.68-14.06,1.54-21.01c0.16-1.31-0.02-2.66,0.04-3.99
	...
	C258.73,308.79,258.75,318.6,258.7,328.4z'
      ...
      <path
        className='st13 fill-pink-600 dark:fill-pink-50'
        d='M261.65,347.31c2.59-4.9,7.06-3.38,10.4-2.1c4.95,1.9,9.92,1.63,14.53,0.59c2.59-0.58,3.43,0.21,4.84,1.37
	C281.5,347.22,271.58,347.26,261.65,347.31z'
      />
      <path
        className='st2 fill-black dark:fill-white'
        d='M538.11,248.69c-0.38,0.37-0.75,0.73-1.13,1.1c-3.33-2.97-3.79-6.39-1.65-10.24c0.58,0.33,1.16,0.66,1.73,0.98
	C536.72,243.34,537.49,246.01,538.11,248.69z'
      />
      <path
        className='st15 fill-pink-200 dark:fill-pink-400'
        d='M512.68,317.07c11.22,0.03,19.18,6.93,19.98,17.32c0.77,10-6.25,19.38-15.7,20.42
	...
	C494.91,321.87,505.75,317.05,512.68,317.07z'
      ...
      <path
        className='st14 fill-black dark:fill-white'
        d='M576.42,356.29c-3.25-0.34-6.57-0.06-10.23-0.06c2.39-2.88,5.56-3.73,8.16-5.45
	...
	C583.2,365.65,582.73,367.42,581.26,368.98z'
      ...
      <path
        className='st6 fill-black dark:fill-white'
        d='M228.48,152.26c-7-9.05-14.15-17.98-21.36-26.86c-0.94-1.16-1.58-3.85-4.12-1.88
	...
	c6.26-0.08,11.94,5.62,12.13,12.17C221.7,160.26,216.01,166.05,209.82,166.13z'
      ...
      <path
        className='st7 fill-black dark:fill-white'
        d='M192.15,186.41c-0.1-1-0.03-2.08-1.51-1.96c-0.98,0.08-1.98,0.13-2.08,1.54c-0.08,1.15-0.29,2.31-0.61,3.41
	...
	C168.76,192.71,168,195.09,166.29,194.5z'
      />
      <path
        className='st16 fill-black dark:fill-white'
        d='M377.31,83.42c-9.28-0.17-16.54,6.56-16.62,15.43c-0.08,8.87,7,15.8,16.25,15.9
	...
	c0.03-6.74,4.84-11.67,11.51-11.78c6.97-0.11,11.78,4.73,11.84,11.92C388.71,106.1,383.95,110.93,376.92,110.87z'
      />
      <path
        className='st17 fill-pink-200 dark:fill-pink-300'
        d='M416.36,312.65c6.49-1.84,12.96-1.04,18.9,1.51c6.67,2.86,6.82,14.57,0.28,18.29
	c-5.94,3.37-12.51,3.83-19.14,1.85C415.54,327.09,415.68,319.87,416.36,312.65z'
      />
      <path
        className='st12 fill-pink-600 dark:fill-pink-50'
        d='M416.36,312.65c0.02,7.22,0.03,14.43,0.05,21.65C414.74,327.09,414.77,319.87,416.36,312.65z'
      />
      <rect
        x='330.53'
        y='295.54'
        className='st18 fill-black dark:fill-white'
        width='54.34'
        height='17.27'
      />
      <rect
      ...
      />
      <polygon
        className='st19 fill-pink-600 dark:fill-pink-50'
        points='293.8,295.2 312.04,295.2 312.04,309.61 293.76,309.61 '
      />
      <polygon
        className='st19 fill-pink-600 dark:fill-pink-50'
        points='293.8,371.89 312.04,371.89 312.04,386.3 293.76,386.3 '
      />
      <polygon
        className='st19 fill-pink-600 dark:fill-pink-50'
        points='239.89,371.89 258.13,371.89 258.13,386.3 239.86,386.3 '
      />
      <polygon
        className='st19 fill-pink-600 dark:fill-pink-50'
        points='240,295.28 258.8,295.28 258.8,310.03 239.97,310.03 '
      />
      <polygon
        className='st12 fill-pink-600 dark:fill-pink-50'
        points='442.47,377.63 448.36,385.91 469.56,385.91 461.73,374.96 '
      />
      <polygon
        className='st12 fill-pink-600 dark:fill-pink-50'
        points='397.65,371.97 397.74,385.83 416.03,385.83 415.79,368.08 '
      />
      <path
        className='st2 fill-black dark:fill-white'
        d='M536.96,267.93c0,0,0.59,2.77-2.15,5.58c-1.04,2.28,0.72,2.05,0.72,2.05l2.77-3.16l0.72-3.29L536.96,267.93z'
      />
      <path
        className='st2 fill-black dark:fill-white'
        d='M482.41,250.59c0,0,3.16-3.87,6.67-7.02l-1.97-1.52l-5.35,5.8L482.41,250.59z'
      />
      <path
        className='st2 fill-black dark:fill-white'
        d='M534.42,238.24c0,0,0.37,2.15,0.37,2.42s0.66,0.42,0.66,0.42l1.79-1.76L534.42,238.24z'
      />
      <path
        className='st12 fill-pink-600 dark:fill-pink-50'
        d='M432.62,295.75c0,0,16.57,1.3,22.74,11.23l-10.08,0.98L432.62,295.75z'
      />
      <path
        className='st2 fill-black dark:fill-white'
        d='M538.2,238.23c0,0-1.21,2.28-1.21,4.37l-1.37-0.13l-0.29-2.92L538.2,238.23z'
      />
      <path
        className='st2 fill-black dark:fill-white'
        d='M534.33,237.94c0,0,0.56,1.22-0.15,4.52l1.12,0.37l1.37-2.57l-0.42-2.67L534.33,237.94z'
      />
      <path
        className='st2 fill-black dark:fill-white'
        d='M533.26,250.42c0,0,0.38,0.9,0.53,1.79l-1.22-0.43l-0.01-1.38L533.26,250.42z'
      />
    </svg>
  );
};
